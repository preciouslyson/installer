...
ENV;
    ...
    private function createFiles(): void
    {
        ...
        $write($this->projectDir . '/config/queue.php', $this->queueConfigFileTemplate());
        ...
        $write($this->projectDir . '/app/Providers/QueueServiceProvider.php', $this->QueueServiceProviderTemplate());
...
PHP;
  ...
  private function QueueServiceProviderTemplate() { return <<<'PHP'
<?php
...
PHP;
  ...
  private function queueConfigFileTemplate() { return <<<'PHP'
<?php
return [
    /*
    |--------------------------------------------------------------------------
