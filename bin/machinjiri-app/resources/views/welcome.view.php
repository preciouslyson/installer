...
<div class="cozy-container">
    ...
    <div class="grid-2cols">
        <div class="card">
            ...
            <div>
                <p><strong>Name:</strong> Machinjiri • <span style="background:#F7EFE7; padding:2px 8px; border-radius:20px;">machinjiri-app</span></p>
                <p><strong>Release:</strong> ^2.1.4 <i class="fas fa-check-circle" style="color:#7AA77B;"></i></p>
